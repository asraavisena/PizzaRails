...
class MenuitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menuitem" do
    assert_difference('Menuitem.count') do
      post menuitems_url, params: { menuitem: { description: @menuitem.description, menuitemID: @menuitem.menuitemID, name: @menuitem.name, price: @menuitem.price } }
    end
  ...
  test "should update menuitem" do
    patch menuitem_url(@menuitem), params: { menuitem: { description: @menuitem.description, menuitemID: @menuitem.menuitemID, name: @menuitem.name, price: @menuitem.price } }
